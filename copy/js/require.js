/*
 ...
 "if(!isNaN(Number(c))) return true;" 添加by doubolin 20170313 修复添加版本号出现的问题
*/
...
var requireConfig = {
	...
	paths: {
		...
		"asDatepicker":'lib/jquery-asDatepicker',
		"vue":'lib/vue.min',
		"vue2":'lib/vue2.min',
		"vueValidator":'lib/vue.validator.min',
		'vuePlugins':'lib/vue.plugins',
		"layer":'lib/layer/layer',
		'pagination':'lib/jQuery.pagination',
		"text": 'lib/text',
		"scoreComponent": 'components/score-component',
		"echarts":'lib/echarts.min',
		"echarts2":'lib/echarts2.min',
		"wordCloud":'lib/echarts-wordcloud.min',
		"_base":'lib/base',
		"china":'lib/china',
		"china1":'lib/china1',
		"world":'lib/world',
		"liquidfill":'lib/echarts-liquidfill',
	},
	shim: {
		"jquery": {
			exports: '$'
